    ...
    <section id="main">
        <div class="container_12">
            <div id="content" class="grid_9">
                <header>
                    <h1 class="page_title">Basic Styles Page</h1>
                </header>
		...
		<div class="alignleft">
		    <img src="img/content/img-left.png" alt="Image left" title="">
		    <div class="img_description">Diamond Necklaces and <br>Pendants</div>
		</div><!-- .alignleft -->
		...
		<div class="alignright">
		    <img src="img/content/img-right.png" alt="Image right" title="">
		    <div class="img_description">Diamond Necklaces and <br>Pendants</div>
		</div><!-- .alignright -->
		...
		<table>
		    <tr class="bg">
			<th>First Column</th><th>Second Column</th><th>Third Column</th><th>Fourth Column</th>
		    </tr>
		    <tr>
			<td>One</td><td>no</td><td>yes</td><td>yes, all</td>
		    </tr>
		    <tr class="bg">
			<td>Two</td><td>0</td><td>1</td><td>all</td>
		    </tr>
		    <tr>
			<td>Three</td><td>$399</td><td>$599</td><td>$799</td>
		    </tr>
		    <tr class="bg">
			<td>Four</td><td><a href="#">Call action</a></td><td><a href="#">Call action</a></td><td><a href="#">Call action</a></td>
		    </tr>
		</table>
		...
		<form class="form_style negative-grid">
		    <br><br>
		    <div class="grid_3">
		    ...
		    <div class="clear"></div>
		    <div class="grid_2">
			<input class="niceCheck" type="checkbox"> Default item
		    </div>
		    <div class="grid_2">
			<input class="niceCheck" type="checkbox" checked> Checked item
		    </div>
		    <div class="grid_2">
			<input class="niceCheck" type="checkbox" disabled> Disabled item
		    </div>
		    ...
		    <div class="clear"></div>
		    <div class="grid_2">
			<input class="niceRadio" type="radio"> Default item
		    </div>
		    <div class="grid_2">
			<input class="niceRadio" type="radio" checked> Checked item
		    </div>
		    <div class="grid_2">
			<input class="niceRadio" type="radio" disabled> Disabled item
		    </div>
		    ...
		    <div class="grid_9"><strong>Textfield</strong><br>
		    ...
		    <div>
			<a href="#"><img src="img/content/what.png" alt="" title=""></a>
			<a href="#">Engagement Ring Settings</a>
			...
			<li>
			    <div class="prev">
				<a href="#"><img src="img/content/product3.png" alt="Product 3" title=""></a>
			    </div>
			...
			<li>
			    <div class="prev">
				<a href="#"><img src="img/content/product4.png" alt="Product 4" title=""></a>
			    </div>
			...
			<ul id="list_banners">
				...
				<div class="prev">
				    <img src="img/home_ban2.png" alt="Banner 2" title="">
				</div><!-- .prev -->

				<h2>Insane discounts</h2>
				<p>on new collection!</p>
 			    </a></li>

			    <li class="banner"><a href="#">
				<div class="prev">
				    <img src="img/home_ban1.png" alt="Banner 1" title="">
				</div><!-- .prev -->
...
<!-- Mirrored from html.diamond.itembridge.com/typography_page.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 21 Feb 2014 08:07:07 GMT -->
</html>
