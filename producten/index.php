        ...
        <div class="container_12">
            <div id="content" class="grid_9">
                ...
                <br>
					...
					<div class="grid_3">
		  			<div class="prev">
						<a href="computer.php"><img src="../img/content/computer.png" alt="Product 2" title=""></a>
		   			</div><!-- .prev -->
					</div><!-- .grid_3 -->
					...
					<div class="grid_3">
		  			<div class="prev">
						<a href="playstation.php"><img src="../img/content/playstation.png" alt="Product 2" title=""></a>
		   			</div><!-- .prev -->
					</div><!-- .grid_3 -->
					...
					<div class="grid_3">
		  			<div class="prev">
						<a href="xbox.php"><img src="../img/content/xbox.png" alt="Product 2" title=""></a>
		   			</div><!-- .prev -->
					</div><!-- .grid_3 -->
